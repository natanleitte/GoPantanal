    ...
    <div class="container">
        ...
        <div class="card">
            ...
            <div class="card-body card-padding">
                ...
                <br/>
                <button onclick="adicionarPasseio()" class="btn btn-block btn-primary waves-effect">Salvar <i class="zmdi zmdi-mail-send"></i></button>
...
//        alert("ola");
        $.ajax({
            url: '<?= base_url(); ?>' + 'index.php/passeio/inserirPasseio',
            type: 'POST',
            data: $("#formPasseio").serialize(),
            success: function (msg) {
                swal("Passeio inserido com sucesso!", "", "success");
                $("#nome, #email, #telefone, #responsavel, #endereco, #cidade").val('');
                window.location.href = '<?= base_url(); ?>' + 'index.php/passeio/';
            }
        });
        return false;
    }
